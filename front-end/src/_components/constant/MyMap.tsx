...
const MyMap: React.FC = () => {
  const [selected, setSelected] = React.useState<google.maps.LatLng | null>(null);

    return (
  <div>
    <div className='flex flex-col justify-center items-center'> 

    <LoadScript googleMapsApiKey="AIzaSyDekV3AERjuxSeNx8rYFNgYWkeyfu_M9QQ">  {/* Replace with your actual API key */}
      <GoogleMap
